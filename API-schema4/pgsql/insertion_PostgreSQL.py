...
def insert_cityjson(file_name, schema_name):
    ...
    if ref_system:
        ...
        cur.execute(insert_metadata,
                    (file_name, ref_system,
                     [min_xy_4236[0], min_xy_4236[1], max_xy_4236[0], max_xy_4236[1]], data_title,
    ...
    for step_id, obj_index in enumerate(insert_order):
        ...
        bbox2d = [min_xy_4236[0], min_xy_4236[1], max_xy_4236[0], max_xy_4236[1]]
        ...
        if ref_system:
            ...
            cur.execute(insert_cityobjects,
                        (obj_id, bbox2d, parents, children, json.dumps(attributes),
                         json.dumps(vertices),
