...
def insert_cityjson(file_name, schema_name):
    ...
    for step_id, obj_index in enumerate(insert_order):
        ...
        if ref_system:
            ...
            VALUES (%s, %s, ST_MakeEnvelope({}, {}, {}, {}, {}),%s, %s, %s, %s,%s, currval('cityjson_id_seq'))
            ...
            insert_cityobjects = """
            INSERT INTO cityobject (obj_id,type,parents, children, attributes, vertices, object, cityjson_id)
